 ...
 * value store. 
 */
public class JPAXMLHelper extends SDOXMLHelperDelegate {

    public JPAXMLHelper(HelperContext helperContext) {
        super(helperContext);
    }

    public JPAXMLHelper(HelperContext helperContext, ClassLoader classLoader) {
