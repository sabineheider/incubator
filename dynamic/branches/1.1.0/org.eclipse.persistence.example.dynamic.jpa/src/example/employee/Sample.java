...
public class Sample {
    ...
    public DynamicEntity basicEmployeeExample1() {
        ...
        DynamicEntity employmentPeriod = newInstance("EmploymentPeriod");
        employmentPeriod.set("endDate", new Date(1996, 0, 1));
        employmentPeriod.set("endDate", new Date(1993, 0, 1));
    ...
    public DynamicEntity basicEmployeeExample10() {
        ...
        DynamicEntity employmentPeriod = newInstance("EmploymentPeriod");
        employmentPeriod.set("endDate", new Date(1991, 10, 11));
        employee.set("period", employmentPeriod);
    ...
    public DynamicEntity basicEmployeeExample12() {
        ...
        DynamicEntity employmentPeriod = newInstance("EmploymentPeriod");
        employmentPeriod.set("endDate", new Date(2001, 11, 31));
        employmentPeriod.set("endDate", new Date(1995, 0, 12));
        employee.set("period", employmentPeriod);
    ...
    public DynamicEntity basicEmployeeExample3() {
        ...
        DynamicEntity employmentPeriod = newInstance("EmploymentPeriod");
        employmentPeriod.set("endDate", new Date(2001, 11, 31));
        employmentPeriod.set("endDate", new Date(1995, 0, 1));
        employee.set("period", employmentPeriod);
    ...
    public DynamicEntity basicEmployeeExample5() {
        ...
        DynamicEntity employmentPeriod = newInstance("EmploymentPeriod");
        employmentPeriod.set("endDate", new Date(2001, 6, 31));
        employmentPeriod.set("endDate", new Date(1995, 4, 1));
        employee.set("period", employmentPeriod);
    ...
    public void assertSame(List<DynamicEntity> dbEmps) {
        ...
        for (int index = 0; index < this.employees.length; index++) {
            DynamicEntity emp = employees[index];
     ...
     */
    class EmployeeComparator implements Comparator<DynamicEntity> {
    ...
    public int[] getEmployeeIds(EntityManager em) {
        ...
        for (int index = 0; index < this.employees.length; index++) {
            if (this.employees[index].get("id", Integer.class) <= 0) {
                DynamicEntity emp = new Queries().queryByExample(em, this.employees[index]);

                if (emp == null) {
                    throw new RuntimeException("Could not find Employee: " + this.employees[index]);
                }
                this.employees[index].set("id", emp.get("id", Integer.class));
            }
