...
public class BatchInConfig {
    ...
    public static void config(EntityManager em, List<?> results, String attribute) {
        ...
        Object value = frMapping.getAttributeValueFromObject(results.get(0));
        ...
        if (!(value instanceof BatchValueHolder)) {
            throw new IllegalArgumentException("No Batching ValueHolder found: " + value);
        }

        BatchValueHolder batchVH = (BatchValueHolder) value;
